<section class="space-y-6">
    ...
    <button
        ...
        class="bg-red-600 hover:bg-red-500 text-white font-bold py-2 px-6 rounded transition-all"
            ...
            <div class="mt-6">
                ...
                <div class="relative">
                    <input
                        ...
                        name="password"
                        type="password"
                        class="elden-input block w-3/4 px-4 py-2 pr-12"
                        placeholder="{{ __('Password') }}"
                        required
                    />
                    <button type="button" onclick="togglePassword('delete_password', 'toggle-delete-password')" class="absolute inset-y-0 right-0 px-3 flex items-center text-slate-400 hover:text-amber-400 transition-colors">
                        <svg id="toggle-delete-password" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
